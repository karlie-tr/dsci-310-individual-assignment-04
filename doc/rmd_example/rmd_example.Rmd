...
```{r horse-plot, out.width = "100%",fig.cap = "Horse populations for all provinces in Canada from 1906 - 1972"}
...
```{r horse-pop-max-sd, fig.cap = "Horse populations for the province with the largest standard deviation", out.width = "70%"}
knitr::include_graphics("../../results/horse_pop_plot_largest_sd.png")
```

In Figure \@ref(fig:horse-pop-max-sd) we zoom in and look at the province of `r largest_sd`, which had the largest spread of values in terms of standard deviation.
